...
class DockReportStaff extends StorableClass(DockReportStaff) {
	object values extends ValuesObject {
		...
		val dockmasterOnDuty = new NullableBooleanFieldValue(self, DockReportStaff.fields.dockmasterOnDuty)
...
object DockReportStaff extends StorableObject[DockReportStaff] {
	...
	object fields extends FieldsObject {
		...
		val dockmasterOnDuty = new NullableBooleanDatabaseField(self, "DOCKMASTER_ON_DUTY")
