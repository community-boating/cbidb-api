...
class PersonMembership extends StorableClass(PersonMembership) {
	...
	override object values extends ValuesObject {
		...
		val startDate = new NullableDateTimeFieldValue(self, PersonMembership.fields.startDate)
		val expirationDate = new NullableDateTimeFieldValue(self, PersonMembership.fields.expirationDate)
