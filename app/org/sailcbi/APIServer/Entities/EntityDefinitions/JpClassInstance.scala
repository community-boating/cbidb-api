...
class JpClassInstance extends StorableClass(JpClassInstance) {
	...
	override object values extends ValuesObject {
		...
		val limitOverride = new NullableIntFieldValue(self, JpClassInstance.fields.limitOverride)
		val nameOverride = new NullableStringFieldValue(self, JpClassInstance.fields.nameOverride)
		val maxAge = new NullableIntFieldValue(self, JpClassInstance.fields.maxAge)
		...
		val minAge = new NullableIntFieldValue(self, JpClassInstance.fields.minAge)
...
object JpClassInstance extends StorableObject[JpClassInstance] {
	...
	object fields extends FieldsObject {
		...
		val limitOverride = new NullableIntDatabaseField(self, "LIMIT_OVERRIDE")
