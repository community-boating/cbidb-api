...
//			)
	...
	def getOrCreatePaymentIntent(pb: PersistenceBroker, stripe: StripeIOController[_], personId: Int, orderId: Int, totalInCents: Int): Future[PaymentIntent] = {
	...
	private def createPaymentIntent(pb: PersistenceBroker, stripe: StripeIOController[_], personId: Int, orderId: Int, closeId: Int): Future[PaymentIntent] = {
