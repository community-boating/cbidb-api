...
case class DateColumnAlias(override val table: TableAlias[_ <: StorableObject[_ <: StorableClass]], override val field: DateDatabaseField)
extends ColumnAlias[DatabaseField[LocalDate]](table, field) {
