...
class HtmldbPlanTable extends StorableClass(HtmldbPlanTable) {
	object values extends ValuesObject {
		...
		val timestamp = new NullableLocalDateTimeFieldValue(self, HtmldbPlanTable.fields.timestamp)
		...
		val other = new NullableUnknownFieldType(self, HtmldbPlanTable.fields.other)
...
object HtmldbPlanTable extends StorableObject[HtmldbPlanTable] {
	val entityName: String = "HTMLDB_PLAN_TABLE"
	...
	object fields extends FieldsObject {
		...
		val timestamp = new NullableLocalDateTimeDatabaseField(self, "TIMESTAMP")
		...
		val other = new NullableUnknownFieldType(self, "OTHER")
