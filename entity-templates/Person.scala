...
class Person extends StorableClass(Person) {
	object values extends ValuesObject {
		...
		val gender = new NullableBooleanFIeldValue(self, Person.fields.gender)
		val dob = new NullableLocalDateTimeFieldValue(self, Person.fields.dob)
		...
		val matchingGifts = new NullableBooleanFIeldValue(self, Person.fields.matchingGifts)
		...
		val temp = new BooleanFIeldValue(self, Person.fields.temp)
		val personType = new NullableDoubleFieldValue(self, Person.fields.personType)
		...
		val swimProof = new NullableDoubleFieldValue(self, Person.fields.swimProof)
		...
		val mergeStatus = new NullableBooleanFIeldValue(self, Person.fields.mergeStatus)
		...
		val guestPortalReg = new NullableBooleanFIeldValue(self, Person.fields.guestPortalReg)
		...
		val protoState = new NullableBooleanFIeldValue(self, Person.fields.protoState)
		...
		val hasAuthedAs = new NullableDoubleFieldValue(self, Person.fields.hasAuthedAs)
		val pwHashScheme = new NullableStringFieldValue(self, Person.fields.pwHashScheme)
		val nextRecurringDonation = new NullableLocalDateTimeFieldValue(self, Person.fields.nextRecurringDonation)
	}
}
...
object Person extends StorableObject[Person] {
	...
	object fields extends FieldsObject {
		...
		val mergeStatus = new NullableBooleanDatabaseField(self, "MERGE_STATUS")
		...
		val guestPortalReg = new NullableBooleanDatabaseField(self, "GUEST_PORTAL_REG")
		...
		val protoState = new NullableBooleanDatabaseField(self, "PROTO_STATE")
		...
		val hasAuthedAs = new NullableDoubleDatabaseField(self, "HAS_AUTHED_AS")
		val pwHashScheme = new NullableStringDatabaseField(self, "PW_HASH_SCHEME", 20)
		val nextRecurringDonation = new NullableLocalDateTimeDatabaseField(self, "NEXT_RECURRING_DONATION")
	}
