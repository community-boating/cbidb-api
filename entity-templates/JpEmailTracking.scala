...
class JpEmailTracking extends StorableClass(JpEmailTracking) {
	object values extends ValuesObject {
		...
		val sendDatetime = new NullableLocalDateTimeFieldValue(self, JpEmailTracking.fields.sendDatetime)
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, JpEmailTracking.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, JpEmailTracking.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, JpEmailTracking.fields.updatedOn)
