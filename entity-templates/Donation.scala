...
class Donation extends StorableClass(Donation) {
	object values extends ValuesObject {
		...
		val personId = new NullableIntFieldValue(self, Donation.fields.personId)
		...
		val donationDate = new NullableLocalDateTimeFieldValue(self, Donation.fields.donationDate)
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, Donation.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, Donation.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, Donation.fields.updatedOn)
...
object Donation extends StorableObject[Donation] {
	...
	object fields extends FieldsObject {
		...
		val donationDate = new NullableLocalDateTimeDatabaseField(self, "DONATION_DATE")
