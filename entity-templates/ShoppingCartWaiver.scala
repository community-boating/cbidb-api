...
class ShoppingCartWaiver extends StorableClass(ShoppingCartWaiver) {
	object values extends ValuesObject {
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartWaiver.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, ShoppingCartWaiver.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartWaiver.fields.updatedOn)
...
object ShoppingCartWaiver extends StorableObject[ShoppingCartWaiver] {
	val entityName: String = "SHOPPING_CART_WAIVERS"
