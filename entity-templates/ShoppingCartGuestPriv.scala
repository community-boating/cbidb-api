...
class ShoppingCartGuestPriv extends StorableClass(ShoppingCartGuestPriv) {
	object values extends ValuesObject {
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartGuestPriv.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, ShoppingCartGuestPriv.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartGuestPriv.fields.updatedOn)
...
object ShoppingCartGuestPriv extends StorableObject[ShoppingCartGuestPriv] {
	val entityName: String = "SHOPPING_CART_GUEST_PRIVS"
