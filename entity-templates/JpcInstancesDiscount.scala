...
class JpcInstancesDiscount extends StorableClass(JpcInstancesDiscount) {
	object values extends ValuesObject {
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, JpcInstancesDiscount.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, JpcInstancesDiscount.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, JpcInstancesDiscount.fields.updatedOn)
		val updatedBy = new NullableStringFieldValue(self, JpcInstancesDiscount.fields.updatedBy)
