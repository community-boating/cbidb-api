...
class ShoppingCartDonation extends StorableClass(ShoppingCartDonation) {
	object values extends ValuesObject {
		...
		val createdOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartDonation.fields.createdOn)
		val createdBy = new NullableStringFieldValue(self, ShoppingCartDonation.fields.createdBy)
		val updatedOn = new NullableLocalDateTimeFieldValue(self, ShoppingCartDonation.fields.updatedOn)
