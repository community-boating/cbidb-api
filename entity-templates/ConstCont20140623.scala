...
class ConstCont20140623 extends StorableClass(ConstCont20140623) {
	object values extends ValuesObject {
		...
		val createdAt = new NullableStringFieldValue(self, ConstCont20140623.fields.createdAt)
		val updatedAt = new NullableStringFieldValue(self, ConstCont20140623.fields.updatedAt)
	}
}

object ConstCont20140623 extends StorableObject[ConstCont20140623] {
	val entityName: String = "CONST_CONT_2014_06_23"
	...
	object fields extends FieldsObject {
		...
		val createdAt = new NullableStringDatabaseField(self, "CREATED_AT", 30)
		val updatedAt = new NullableStringDatabaseField(self, "UPDATED_AT", 30)
	}
